...
services.AddScoped<IEtsyShopManagementService, EtsyShopManagementService>(_ => new EtsyShopManagementService(clientId));
    ...
    public static IServiceCollection AddEtsyShopManagementServiceTransient(this IServiceCollection services, string clientId) =>
services.AddTransient<IEtsyShopManagementService, EtsyShopManagementService>(_ => new EtsyShopManagementService(clientId));
